...
#Seventh test case: 1 directory and 2 regular files
echo TEST CASE 7: tar1.tar test-3.txt test_folder array.h
rm create_archive.tar
rm tar1.tar
rm create_archive.txt
rm tar1.txt
tar -cf tar1.tar test-3.txt test_folder array.h
./my_tar -cf create_archive.tar test-3.txt test_folder  array.h
cat -e tar1.tar > tar1.txt
cat -e create_archive.tar > create_archive.txt
echo DIFF TAR1.TXT AND CREATE_ARCHIVE.TXT
diff tar1.txt create_archive.txt
...
#Eigth test case: 2 directories
echo TEST CASE 8: tar1.tar test_folder test_folder_copy
rm create_archive.tar
rm tar1.tar
rm create_archive.txt
rm tar1.txt
tar -cf tar1.tar test_folder test_folder_copy
./my_tar -cf create_archive.tar test_folder test_folder_copy
cat -e tar1.tar > tar1.txt
cat -e create_archive.tar > create_archive.txt
echo DIFF TAR1.TXT AND CREATE_ARCHIVE.TXT
diff tar1.txt create_archive.txt
